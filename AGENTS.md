...
- Do not build a release binary for routine edits. Use the cached debug build when a compile is needed, and build release only when an optimized binary was requested.
